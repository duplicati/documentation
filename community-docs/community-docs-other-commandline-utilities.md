# Community docs: other commandline utilities

This page is copied from the community documentation: [See the original version of this page](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/)
...
### Duplicati.GUI.TrayIcon.exe[¶](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/#duplicatiguitrayiconexe) <a href="#duplicatiguitrayiconexe" id="duplicatiguitrayiconexe"></a>
...
See [Duplicati.Server.exe](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/07-other-command-line-utilities/#duplicatiserverexe) for more information about these command line options.

### Duplicati.Server.exe[¶](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/#duplicatiserverexe) <a href="#duplicatiserverexe" id="duplicatiserverexe"></a>
...
### Duplicati.WindowsService.exe[¶](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/#duplicatiwindowsserviceexe) <a href="#duplicatiwindowsserviceexe" id="duplicatiwindowsserviceexe"></a>
...
See [Duplicati.Server.exe](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/#duplicatiserverexe) for more information about supported command line options.

### Duplicati.CommandLine.BackendTester.exe[¶](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/#duplicaticommandlinebackendtesterexe) <a href="#duplicaticommandlinebackendtesterexe" id="duplicaticommandlinebackendtesterexe"></a>
...
### Duplicati.CommandLine.BackendTool.exe[¶](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/#duplicaticommandlinebackendtoolexe) <a href="#duplicaticommandlinebackendtoolexe" id="duplicaticommandlinebackendtoolexe"></a>
...
### Duplicati.Library.Snapshots.exe[¶](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/#duplicatilibrarysnapshotsexe) <a href="#duplicatilibrarysnapshotsexe" id="duplicatilibrarysnapshotsexe"></a>
...
### Duplicati.Library.AutoUpdater.exe[¶](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/#duplicatilibraryautoupdaterexe) <a href="#duplicatilibraryautoupdaterexe" id="duplicatilibraryautoupdaterexe"></a>
...
### Duplicati.CommandLine.RecoveryTool.exe[¶](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/#duplicaticommandlinerecoverytoolexe) <a href="#duplicaticommandlinerecoverytoolexe" id="duplicaticommandlinerecoverytoolexe"></a>

This tool can be used in very specific situations, where you have to restore data from a corrupted backup. The procedure for recovering from this scenario is covered in [Disaster Recovery](https://prev-docs.duplicati.com/en/latest/08-disaster-recovery).
...
> ![](https://prev-docs.duplicati.com/en/latest/icon_info.png) This is a radical operation to your backup files. Therefore, it is recommended to keep a copy of your remote files before this operation is performed. Using the Duplicati Recovery Tool incorrectly may result in unusable backup files.

***

***

> ![](https://prev-docs.duplicati.com/en/latest/icon_important.png) Warning: Before recompressing, delete the local database and recreate the local database again after recompressing. Do this before executing any operation on the backup so that Duplicati can read the new file names from remote storage.

***

### Duplicati.CommandLine.ConfigurationImporter.exe[¶](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/#duplicaticommandlineconfigurationimporterexe) <a href="#duplicaticommandlineconfigurationimporterexe" id="duplicaticommandlineconfigurationimporterexe"></a>
