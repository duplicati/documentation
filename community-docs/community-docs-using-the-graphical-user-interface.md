# Community docs: using the graphical user interface

This page is copied from the community documentation: [See the original version of this page](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/)

### Introduction to the Graphical User Interface[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#introduction-to-the-graphical-user-interface) <a href="#introduction-to-the-graphical-user-interface" id="introduction-to-the-graphical-user-interface"></a>
...
![](https://prev-docs.duplicati.com/en/latest/ss_trayicon_01.png)

Click _Open_ in the popup menu that shows up:\
![](https://prev-docs.duplicati.com/en/latest/ss_trayicon_02.png)

Note that the tray icon can have different colors:\
![](https://prev-docs.duplicati.com/en/latest/ss_trayicon_01.png) Duplicati is inactive.\
![](https://prev-docs.duplicati.com/en/latest/ss_trayicon_03.png) Duplicati is active. A backup job is running.\
![](https://prev-docs.duplicati.com/en/latest/ss_trayicon_04.png) There is an error message that is not yet acknowledged.&#x20;
...
This can be changed by providing command line options to Duplicati.Server.exe or Duplicati.GUI.TrayIcon.exe. See [Duplicati.GUI.TrayIcon.exe](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/#duplicatiguitrayiconexe), [Duplicati.Server.exe](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/#duplicatiserverexe) and [Duplicati.WindowsService.exe](https://prev-docs.duplicati.com/en/latest/07-other-command-line-utilities/#duplicatiwindowsserviceexe) for more information.

The first time you start the Duplicati Web interface, this message is presented:\
![](https://prev-docs.duplicati.com/en/latest/ss_usinggui_01.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_usinggui_02.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_usinggui_03.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_usinggui_04.png)

On screens with a lower resolution, Duplicati looks like this:\
![](https://prev-docs.duplicati.com/en/latest/ss_usinggui_05.png)

In this layout, a click on the Menu icon shows the main menu:\
![](https://prev-docs.duplicati.com/en/latest/ss_usinggui_06.png)

### Components of the Graphical User Interface[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#components-of-the-graphical-user-interface) <a href="#components-of-the-graphical-user-interface" id="components-of-the-graphical-user-interface"></a>
...
![](https://prev-docs.duplicati.com/en/latest/ss_guicomponents_01.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_guicomponents_02.png)

The Pause and Throttle buttons can be used for keeping control over the bandwidth used by Duplicati.

![](https://prev-docs.duplicati.com/en/latest/ss_guicomponents_03.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_guicomponents_04.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_guicomponents_05.png)

A short description of the menu items:

|                                                                        |                                                                                                                          |
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| ![](https://prev-docs.duplicati.com/en/latest/ss_guicomponents_06.png) | Leave the current submenu and return to the home screen.                                                                 |
| ![](https://prev-docs.duplicati.com/en/latest/ss_guicomponents_07.png) | Add a new backup configuration.                                                                                          |
| ![](https://prev-docs.duplicati.com/en/latest/ss_guicomponents_08.png) | Restore files from an already configured backup job or directly from the backend or from an imported configuration file. |
| ![](https://prev-docs.duplicati.com/en/latest/ss_guicomponents_09.png) | Change general program settings and define default settings for all backup jobs.                                         |
| ![](https://prev-docs.duplicati.com/en/latest/ss_guicomponents_10.png) | Show the Duplicati log files and view events in real time.                                                               |
| ![](https://prev-docs.duplicati.com/en/latest/ss_guicomponents_11.png) | Show information about the current Duplicati version and system information.                                             |
| ![](https://prev-docs.duplicati.com/en/latest/ss_guicomponents_12.png) | Logs out from the Duplicati Graphical User Interface. This item is omitted if no password is set to the User Interface.  |

### Creating a new backup job[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#creating-a-new-backup-job) <a href="#creating-a-new-backup-job" id="creating-a-new-backup-job"></a>
...
![](https://prev-docs.duplicati.com/en/latest/ss_newbackup_01.png)
...
> ![](https://prev-docs.duplicati.com/en/latest/icon_important.png) Losing your encryption key will render your backup files useless and makes restore operations impossible. Always store your encryption key in a safe place, separated from your backup files and not on your computer that contains the Duplicati source files.
...
> ![](https://prev-docs.duplicati.com/en/latest/icon_important.png) Encryption can be disabled, but is strongly discouraged, especially if you upload your backup files over the internet to a public cloud storage solution. Click Next to continue.

***

![](https://prev-docs.duplicati.com/en/latest/ss_newbackup_02.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_newbackup_03.png)

***

> ![](https://prev-docs.duplicati.com/en/latest/icon_important.png) Never store multiple backups in the same remote location. Backup data files from multiple backup jobs will interfere with each other and will result in failed backup operations. Always create a new remote folder for each backup job that you set up.

***

***

> ![](https://prev-docs.duplicati.com/en/latest/icon_info.png) Each Storage Type has its own requirements that you need to fill in. For an S3 compatible backend, you need to specify a Bucket name, region and storage class. For other backends, like Google Drive or Microsoft OneDrive, you need to create an AuthID token to grant permission to Duplicati to get access to that backend.
...
![](https://prev-docs.duplicati.com/en/latest/ss_newbackup_04.png)
...
> ![](https://prev-docs.duplicati.com/en/latest/icon_info.png) You can review your selections under Source data in the file picker.
...
![](https://prev-docs.duplicati.com/en/latest/ss_newbackup_07.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_newbackup_08.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_newbackup_09.png)
...
> ![](https://prev-docs.duplicati.com/en/latest/icon_important.png) The Upload volume size is not the maximum capacity that is offered by your storage provider. It is the size of each chunk of data that is uploaded to the backend during a backup operation. Increasing the size of an upload volume will reduce the number of files at the backend, but will require to download more data when performing restore operations. See [Choosing sizes in Duplicati](https://prev-docs.duplicati.com/en/latest/appendix-c-choosing-sizes-in-duplicati) for more information about block- and volume sizes.
...
![](https://prev-docs.duplicati.com/en/latest/ss_newbackup_10.png)

Under _Advanced options_ there is an extensive list of options to fine-tune your backup job. Click _Pick an option_ and select which option you want to set. This option is added to a list where you can change the value of that option.

***

> ![](https://prev-docs.duplicati.com/en/latest/icon_important.png) This is only for advanced users. Don't use this, unless you know exactly what you're doing. Choosing incorrect values may cause unusable backups.

***

![](https://prev-docs.duplicati.com/en/latest/ss_newbackup_11.png)

Click the _Save_ button. Your first backup job should show up in the main window.

![](https://prev-docs.duplicati.com/en/latest/ss_newbackup_12.png)
...
> ![](https://prev-docs.duplicati.com/en/latest/icon_info.png) When importing a backup job from a configuration file, a new database will be created, using a random filename. If the configuration file contains the name of a local database, this name will be ignored. This will prevent problems caused by multiple backup jobs using the same local database.\
...
### Running a backup job[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#running-a-backup-job) <a href="#running-a-backup-job" id="running-a-backup-job"></a>
...
* Click Run now, just under the backup name.\
  ![](https://prev-docs.duplicati.com/en/latest/ss_runbackup_01.png)
* Click on the backup name. Then click Run now under Operations.\
  ![](https://prev-docs.duplicati.com/en/latest/ss_runbackup_02.png)

The progress bar indicates that the backup job starts:

![](https://prev-docs.duplicati.com/en/latest/ss_runbackup_03.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_runbackup_04.png)

After all files have been processed, some additional operations are performed.

![](https://prev-docs.duplicati.com/en/latest/ss_runbackup_05.png)

If there are files still uploading in the background, Duplicati will wait for them to complete.

![](https://prev-docs.duplicati.com/en/latest/ss_runbackup_06.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_runbackup_07.png)

![](https://prev-docs.duplicati.com/en/latest/ss_runbackup_08.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_runbackup_09.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_runbackup_10.png)

### Restoring files from a backup[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#restoring-files-from-a-backup) <a href="#restoring-files-from-a-backup" id="restoring-files-from-a-backup"></a>
...
* By clicking the backup name and click Restore files ? under Operations.\
  ![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_01.png)
* By clicking Restore in the main menu, select the backup you want to restore from and clicking Next.\
  ![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_02.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_03.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_04.png)

***

> ![](https://prev-docs.duplicati.com/en/latest/icon_info.png) Highlighting does not actually select the files you type in. Only files with a green check mark will be restored.
...
![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_05.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_06.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_07.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_08.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_09.png)

### Restoring files if your Duplicati installation is lost[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#restoring-files-if-your-duplicati-installation-is-lost) <a href="#restoring-files-if-your-duplicati-installation-is-lost" id="restoring-files-if-your-duplicati-installation-is-lost"></a>
...
If Duplicati isn't installed on the computer you want to restore to, download and install Duplicati first. See [Installation](https://prev-docs.duplicati.com/en/latest/02-installation) for more information.
...
![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_10.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_11.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_15.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_16.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_17.png)

Then file information is being retrieved.

![](https://prev-docs.duplicati.com/en/latest/ss_restorefiles_18.png)

After the Fetching path information task has been completed, the restore process is exactly the same as described in [Restoring files from a backup](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#restoring-files-from-a-backup).

### Editing an existing backup[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#editing-an-existing-backup) <a href="#editing-an-existing-backup" id="editing-an-existing-backup"></a>
...
![](https://prev-docs.duplicati.com/en/latest/ss_editbackup_01.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_editbackup_02.png)
...
> ![](https://prev-docs.duplicati.com/en/latest/icon_important.png) Many settings can be modified, but some settings cannot be changed after the initial backup is made. For obvious reasons, the passphrase and the block size need to stay the same once the initial backup is completed.

***

***

> ![](https://prev-docs.duplicati.com/en/latest/icon_important.png) Adding or modifying advanced options may have unwanted effects. Never modify settings in a backup configuration, unless you are sure what the consequences of the change are.

***

### Exporting a backup job configuration[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#exporting-a-backup-job-configuration) <a href="#exporting-a-backup-job-configuration" id="exporting-a-backup-job-configuration"></a>
...
![](https://prev-docs.duplicati.com/en/latest/ss_exportbackup_01.png)

To export the current configuration as a ready-to-use command, select _As Command-line_ and click the _Export_ button.

![](https://prev-docs.duplicati.com/en/latest/ss_exportbackup_02.png)

The result is a Duplicati backup command that you can use with a scheduler of your choice.&#x20;

![](https://prev-docs.duplicati.com/en/latest/ss_exportbackup_03.png)

***

> ![](https://prev-docs.duplicati.com/en/latest/icon_info.png) When using an external scheduler, error messages generated by the program may not be visible, and it is therefore recommend to use one of the available [Reporting options](https://prev-docs.duplicati.com/en/latest/06-advanced-options/#reporting-options).

***

If you want to export to a file, select _To file_ and click the _Export_ button.

![](https://prev-docs.duplicati.com/en/latest/ss_exportbackup_04.png)
...
![](https://prev-docs.duplicati.com/en/latest/icon_important.png) Configuration files contain sensitive information, like your backup passphrase and credentials to authenticate to your backend. This information is stored as plain text in unencrypted configuration files. If you choose not to encrypt the configuration file, be sure to store it somewhere nobody else has access to.

![](https://prev-docs.duplicati.com/en/latest/icon_important.png) Losing the passphrase will make the configuration file useless. Without the passphrase it is impossible to extract information from the configuration file. Store the passphrase in a safe place.

![](https://prev-docs.duplicati.com/en/latest/icon_important.png) Never store the configuration file and, if applicable, the passphrase on the computer running Duplicati. It is likely that you need them when your computer is lost. Be sure to keep access to file and passphrase if you can't use your computer anymore.
...
### Deleting a backup job configuration[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#deleting-a-backup-job-configuration) <a href="#deleting-a-backup-job-configuration" id="deleting-a-backup-job-configuration"></a>
...
![](https://prev-docs.duplicati.com/en/latest/ss_deletebackup_01.png)
...
Before deleting a backup job, it is recommended to export the backup job settings to a file. The _Export configuration_ button is a quick link to this function. More about exporting backup configuration can be found in [Exporting a backup job configuration](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#exporting-a-backup-job-configuration).
...
> ![](https://prev-docs.duplicati.com/en/latest/icon_important.png) This is an irreversible process. If your storage provider does not support previous versions or something similar, restoring files from this backup set will be impossible.
...
![](https://prev-docs.duplicati.com/en/latest/ss_deletebackup_02.png)

Confirm your choices by clicking _Yes_.

![](https://prev-docs.duplicati.com/en/latest/ss_deletebackup_03.png)

The backup job is removed from your Duplicati installation.

### Database management[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#database-management) <a href="#database-management" id="database-management"></a>
...
![](https://prev-docs.duplicati.com/en/latest/ss_dbmgmt_01.png)

You have several options in the screen that appears.

![](https://prev-docs.duplicati.com/en/latest/ss_dbmgmt_02.png)
...
### Verifying backend files[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#verifying-backend-files) <a href="#verifying-backend-files" id="verifying-backend-files"></a>
...
![](https://prev-docs.duplicati.com/en/latest/ss_verifybackup_01.png)

The Verify operation starts immediately after clicking _Verify files_.

![](https://prev-docs.duplicati.com/en/latest/ss_verifybackup_02.png)

If any errors or warnings occur, they will be displayed in a popup at the bottom of the Duplicati screen.

### Compacting files at the backend[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#compacting-files-at-the-backend) <a href="#compacting-files-at-the-backend" id="compacting-files-at-the-backend"></a>
...
![](https://prev-docs.duplicati.com/en/latest/ss_compacting_01.png)

The compacting procedure starts immediately.

![](https://prev-docs.duplicati.com/en/latest/ss_compacting_02.png)
...
### Using the Command line tools from within the Graphical User Interface[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#using-the-command-line-tools-from-within-the-graphical-user-interface) <a href="#using-the-command-line-tools-from-within-the-graphical-user-interface" id="using-the-command-line-tools-from-within-the-graphical-user-interface"></a>
...
> ![](https://prev-docs.duplicati.com/en/latest/icon_important.png) If you want to use the command line tools, some basic knowledge of how these tools work is required. Improper use of the Commandline tools may damage or delete your backup files.

***

To open a command line screen, click the backup name and click _Commandline ..._ under _Advanced_.

![](https://prev-docs.duplicati.com/en/latest/ss_commandlinegui_01.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_commandlinegui_02.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_commandlinegui_03.png)
...
> ![](https://prev-docs.duplicati.com/en/latest/icon_info.png) All commandline arguments must be entered at separate lines.

***

![](https://prev-docs.duplicati.com/en/latest/ss_commandlinegui_04.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_commandlinegui_05.png)

Click the _Run "find" command now_ button. The results are listed in the Duplicati main screen.

![](https://prev-docs.duplicati.com/en/latest/ss_commandlinegui_06.png)

**Example 2**: Find the differences between 2 backups.

The COMPARE command lists differences between 2 backups. Choose _compare_ in the _Comman&#x64;_&#x70;ull-down menu. Leave the Target URL unchanged and enter the base version number and the version number to compare at separate lines.

![](https://prev-docs.duplicati.com/en/latest/ss_commandlinegui_07.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_commandlinegui_08.png)

### Viewing the log files of a backup job[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#viewing-the-log-files-of-a-backup-job) <a href="#viewing-the-log-files-of-a-backup-job" id="viewing-the-log-files-of-a-backup-job"></a>
...
![](https://prev-docs.duplicati.com/en/latest/ss_showlog_01.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_showlog_02.png)
...
### Creating a bug report[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#creating-a-bug-report) <a href="#creating-a-bug-report" id="creating-a-bug-report"></a>
...
![](https://prev-docs.duplicati.com/en/latest/ss_createbugreport_01.png)

The creation of the bug report starts immediately.

![](https://prev-docs.duplicati.com/en/latest/ss_createbugreport_02.png)

When completed, a message is displayed and you can download the generated report.

![](https://prev-docs.duplicati.com/en/latest/ss_createbugreport_03.png)

Click the Download button and send the report to the Duplicati development team for further investigation.

### Settings in Duplicati[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#settings-in-duplicati) <a href="#settings-in-duplicati" id="settings-in-duplicati"></a>
...
![](https://prev-docs.duplicati.com/en/latest/ss_settings_01.png)
...
> ![](https://prev-docs.duplicati.com/en/latest/icon_info.png) If you are using a firewall, don't forget to make an access rule to allow incoming traffic using the port the Duplicati server listens on (default port is TCP port 8200).

***

***

> ![](https://prev-docs.duplicati.com/en/latest/icon_important.png) When allowing remote access, setting a password to the user interface is highly recommended. Anonymous access to Duplicati will give anybody access to your personal files.

***

***

> ![](https://prev-docs.duplicati.com/en/latest/icon_important.png) If Duplicati is registered as a Windows service, setting a password to the user interface is highly recommended. If the Duplicati service is started using the SYSTEM account, anyone with access to the user interface will have access to the complete file system of the local host. Don't allow remote access when running Duplicati as a service, unless strictly needed.
...
![](https://prev-docs.duplicati.com/en/latest/ss_settings_02.png)

With the User Interface settings you can change the interface language and choose a color scheme.

![](https://prev-docs.duplicati.com/en/latest/ss_settings_03.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_settings_04.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_settings_05.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_settings_06.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_settings_07.png)
...
![](https://prev-docs.duplicati.com/en/latest/ss_settings_08.png)
...
### Viewing the Duplicati Server Logs[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#viewing-the-duplicati-server-logs) <a href="#viewing-the-duplicati-server-logs" id="viewing-the-duplicati-server-logs"></a>
...
### Getting information about your setup[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#getting-information-about-your-setup) <a href="#getting-information-about-your-setup" id="getting-information-about-your-setup"></a>
...
![](https://prev-docs.duplicati.com/en/latest/ss_about_01.png)

_General_ will show information about Duplicati and the version you work with. You can check for updates using the _Check for updates now_ link in this overview. If a new version for your update channel is available, a message will be displayed with the new version number. Use the _Downloa&#x64;_&#x61;nd _Activate_ buttons to update your Duplicati installation to the latest version.
...
### Updating Duplicati[¶](https://prev-docs.duplicati.com/en/latest/03-using-the-graphical-user-interface/#updating-duplicati) <a href="#updating-duplicati" id="updating-duplicati"></a>
